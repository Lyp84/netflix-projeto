...
grant all privileges on database seu_banco to admin_netflix;
...
grant connect on database seu_banco to app_netflix;
...
grant connect on database seu_banco to relatorios_netflix;
...
grant connect on database seu_banco to dev_netflix;
